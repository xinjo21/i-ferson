...
export const questions: QuestionT[] = [
  ...
  },
  {
    ...
    answers: [
      ...
      "Planning, organizing, or learning something useful",
    ],
  },
  {
    ...
    answers: [
      ...
      "The organizer, keeping things moving",
    ],
  },
  {
    ...
    answers: [
      ...
      "Creating a plan or system to solve it",
    ],
  },
  {
    ...
    answers: [
      ...
      "Stay calm but draw a clear line",
    ],
  },
  {
    ...
    answers: [
      ...
      "Structured with clear direction",
    ],
  },
  {
    question: "You value:",
